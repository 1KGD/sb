...
Ideally, STARBLOOM has first-class modding support. The ability to create new components, tiles, biomes, systems, etc., and have them interact with existing systems in a simple and intuitive manner is crucial.
